 ...
 *
 */
	Configure::write('Routing.prefixes', array('vender', 'admin','api'));
 ...
 */
	Configure::write('Security.salt', 'DYhG93b0qyJfIxf1234VoUubWwvniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '76859111657453542496749683645');
